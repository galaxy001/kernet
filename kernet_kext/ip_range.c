...
{    
    ...
    // Facebook
    kn_append_readable_ip_range_entry_default_ports("69.63.176.0", 20, ip_range_apply_kernet);
    kn_append_readable_ip_range_entry_default_ports("69.171.224.0", 19, ip_range_apply_kernet);      
